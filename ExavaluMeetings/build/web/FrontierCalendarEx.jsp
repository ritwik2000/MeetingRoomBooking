<%-- 
    Document   : FrontierCalendarEx
    Created on : 17 Oct, 2015, 6:11:18 PM
    Author     : Anyuser
--%>
...
$(document).ready(function(){
	...
	$("#BtnLoadFromDB").click(function() {
		var username = "1";															//needed parameter to be executed jin the servlet code. Chnage the parameter or add parameters as per your requirement
		$.ajax({  
			type: "POST",  																					//type of request
			url: "calender2",  																		//actually calling the servlet
					...
					for(i = 0; i < mainJSONArray.length; i++)
					{
						...
						if(mainJSONArray[i].trim().length > 0)
						{
							...
							for(j = 0; j < indexValue.length; j++)
							{
								...
								else if(fieldName == "Event_Start_Date")
								{
								...
								else if(fieldName == "Event_Description")
								{
		...
		buttons: {
			'Add Event': function() {
				...
				if(what == ""){
					...
					var username = "Ritwik_Ghosh";															//needed parameter to be executed jin the servlet code. Chnage the parameter or add parameters as per your requirement
					...
					$.ajax({  
                          type: "POST",  
                          url: "calender1",  
                          data: "username="+ username+"&evtStartDate=" + startDate + "&evtEndDate=" + endDate + "&evtDescription=" + what + "&evtBackgroundColor" + $("#colorBackground").val() + "&evtForegroundColor=" + $("#colorForeground").val(),
                          success: function(msg){  
                                alert(msg);
                          }  
                      }); 
