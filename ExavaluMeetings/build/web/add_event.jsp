    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form role="form" method="POST" action="add_event_servlet">
                    

                    <i><legend class="text-center"><span style="color:#363795;font-weight:bold">-Registration Form-</span></legend></i>
