<%-- 
    Document   : BookMeeting
    Created on : 19 Mar, 2021, 1:03:33 PM
    Author     : Sanket
--%>
...
<div mbsc-page class="demo-create-read-update-delete-CRUD">
  <div style="height:100%">
    ...
    <div id="demo-add-popup">
        ...
        <form role="form" method="POST" action="BookMeeting">
        <div class="mbsc-form-group">
            <label>
                     Title
                <input mbsc-input id="event-title" name="description"/>
            </label>
            <label>
                 Description
                <input mbsc-input id="event-desc" name="attendees"/>
            </label>
        </div>
        <div class="mbsc-form-group">
            ...
            <label for="start-input">
                Starts
                <input mbsc-input id="start-input" name="startTime"/>
            </label>
            <label for="end-input">
                Ends
                <input mbsc-input id="end-input" name="endTime" />
            </label>
...
<script>
    ...
    mobiscroll.setOptions({
        ...
        themeVariant: 'light'              // More info about themeVariant: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-themeVariant
    });
    var calendar,
        popup,
        range,
    ...
    function createAddPopup(elm) {
       ...
       // set popup header text and buttons for adding
        popup.setOptions({
            headerText: 'New event',       // More info about headerText: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-headerText
            buttons: [                     // More info about buttons: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-buttons
                'cancel',
                {
                    text: 'Add',
                    keyCode: 'enter',
       ...
       // fill popup with a new event data
        ...
        mobiscroll.getInst(descriptionTextarea).value =tempEvent.description;
    ...
    function createEditPopup(args) {
        ...
        popup.setOptions({
            headerText: 'Edit event',      // More info about headerText: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-headerText
            buttons: [                     // More info about buttons: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-buttons
                'cancel',
                {
                    text: 'Save',
    ...
    calendar = mobiscroll.eventcalendar('#demo-add-delete-event', {
        clickToCreate: 'double',           // More info about clickToCreate: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-clickToCreate
        dragToCreate: true,                // More info about dragToCreate: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-dragToCreate
        dragToMove: true,                  // More info about dragToMove: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-dragToMove
        dragToResize: true,                // More info about dragToResize: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-dragToResize
        view: {                            // More info about view: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-view
            schedule: { type: 'week' }
        },
        data: myData,                      // More info about data: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-data
        onEventClick: function (args) {    // More info about onEventClick: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#event-onEventClick
            oldEvent = { ...args.event };
        ...
        onEventCreated: function (args) {  // More info about onEventCreated: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#event-onEventCreated
            popup.close();
            // store temporary event
            tempEvent = args.event;
            createAddPopup(args.target);
        },
        onEventDeleted: function (args) {  // More info about onEventDeleted: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#event-onEventDeleted
            mobiscroll.snackbar({ 
                button: {
                    action: function () {
    ...
    popup = mobiscroll.popup('#demo-add-popup', {
        ...
        fullScreen: true,
        onClose: function () {             // More info about onClose: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#event-onClose
            if (deleteEvent) {
        ...
        responsive: {                      // More info about responsive: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-responsive
            medium: {
                display: 'bubble',         // Specify display mode like: display: 'bottom' or omit setting to use default
                width: 400,                // More info about width: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-width
                fullScreen: false,
                touchUi: false
            }
        }
    ...
    range = mobiscroll.datepicker('#event-date', {
        ...
        touchUi: true,
        responsive: datePickerResponsive,  // More info about responsive: https://docs.mobiscroll.com/5-1-1/javascript/eventcalendar#opt-responsive
