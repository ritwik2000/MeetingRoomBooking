            ...
            <div class="b-content__left">
                ...
                <div class="b-content__inner">
                    <div class="b-content__vertical">
                        ...
                        <form method="post" action="AdminLogin" role="form" id="login-form" name="login-form" class="f-std">
                            <ul>
                                <li id="errorMessage">
                                    <a href="#">${error}</span></a>
                                </li>
                            ...
                            <p class="inp__btn">
                                <button type="button" id="login" name="login" class="btn"><span class="btn__text">Admin Login</span></button>
